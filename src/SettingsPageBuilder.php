...
abstract class SettingsPageBuilder
{
    ...
    public function register_sections()
    {
        ...
        foreach ($sections as $section) {
            ...
            $section_args = array(
                ...
                'before_section' => sprintf('<div id="%s" class="settings_section">', $section['id'] ),
                'after_section'  => '</div>',
            );

            if ( isset($section['description']) && !empty($section['description']) ){
                $section_args['description'] = '<div>'.$section['description'].'</div>';
            }

            add_settings_section( $section['id'], $section['label'], [$this, 'section_callback'], $this->get_slug(), $section_args );
            ...
            foreach ($section['fields'] as $subfield) {
                ...
                add_settings_field($subfield['id'], $subfield['label'], [$this, 'field_callback'], $this->get_slug(), $section['id'], $subfield);
    ...
    */
    ...
    {
        if ( isset($section['description']) && !empty($section['description']) ){
            echo '<div id="'.$section['id'].'">'.$section['description'].'</div>';
        }
    }
    ...
    public function field_callback($arguments)
    {
        ...
        // Force arguments into array and merge with defaults
